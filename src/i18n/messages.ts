export const ja = {
  ...
  'settings.usageSection': '利用量',
  'settings.usagePeriod': '集計期間',
  'settings.usagePeriodValue': '{start} 〜 {end}',
  'settings.usageRequests': 'リクエスト数',
  'settings.usageTokens': 'トークン',
  'settings.usageTokensDetail': '入力 {prompt} / 出力 {completion} / 合計 {total}',
  'settings.usageMissing': 'トークン未取得の呼び出し: {count}',
  'settings.usageResetDay': '利用量のリセット日',
  'settings.usageResetDayHint': '毎月この日に利用量をリセットします（1〜28日）',
  'settings.usageReset': '今月の利用量をリセット',
  'settings.usageResetConfirm': '現在の期間の利用量カウントをゼロにします。よろしいですか？',
  ...
  'menu.save': '保存',
  'menu.settings': '設定',
  'menu.workspaceRules': 'ワークスペースルールを編集',
  'menu.workspaceGlossary': '用語集を編集',
  'menu.quit': '終了',
  'menu.undo': '元に戻す',
  'menu.redo': 'やり直し',
  ...
  'menu.zoomOut': '縮小',
  'menu.terminal': 'ターミナル',
  'menu.terminalShortcut': 'Ctrl+@',
  'menu.newTerminal': '新しいターミナルを開く',
  'menu.newTerminalShortcut': 'Ctrl+Shift+@',
  ...
  'menu.showGit': 'Git を表示',
  'menu.showDesk': 'クリップを表示',
  ...
  'sidebar.git': 'Git',
  'sidebar.desk': 'クリップ',
  'desk.noWorkspace': 'フォルダを開くとクリップを使えます',
  'desk.inbox': '取り込み',
  'desk.outbox': '送り出し',
  'desk.inboxEmpty': 'ホットキーでテキストを取り込めます（既定: Ctrl+Alt+I）',
  'desk.outboxEmpty': '下書きを作るとここに並びます',
  'desk.markDone': '済',
  'desk.markAllDone': 'すべて済',
  'desk.markAllDoneConfirm': '取り込みをすべて処理済みにしますか？（done へ移動します）',
  'desk.hasOutbox': '作成済み',
  'desk.copied': 'コピー済み',
  'desk.archive': '済',
  'desk.archiveAll': 'すべて済',
  'desk.archiveAllConfirm': '送り出しをすべて処理済みにしますか？（アーカイブします）',
  'desk.delete': '削除',
  'desk.deleteConfirm': 'この Outbox 下書きを完全に削除しますか？\n{name}',
  'desk.deleteInboxConfirm': 'この取り込みを完全に削除しますか？\n{name}',
  'desk.outbox.notOutbox': 'outbox のファイルではありません',
  'desk.open': '開く',
  'desk.shipCheck': '検品してコピー',
  'desk.createDraft': '下書きを作る…',
  'desk.createDraftShort': '下書き…',
  'desk.draftTitle': '下書きを作る',
  'desk.draftPreset': '形式',
  'desk.preset.mail': 'メール',
  'desk.preset.minutes': '議事録',
  'desk.preset.report': '報告',
  'desk.preset.chat': 'チャット投稿',
  'desk.draftCreate': '作成',
  ...
  'desk.capture.empty':
    'クリップボードに文字がありません。メールやブラウザでコピーしてから、もう一度ホットキーを押してください。',
  'desk.capture.tooLarge':
    'テキストが大きすぎます（上限 512KB）。短くコピーしてから、もう一度試してください。',
  'desk.capture.notifyOkTitle': '取り込み完了',
  ...
  'desk.status.ready': 'コピー済み',
  'desk.status.archived': 'アーカイブ',
  'desk.fromSource': '元: {name}',
  'settings.desk': 'クリップ',
  'settings.deskCapture': 'クリップボード取込ホットキー',
  'settings.deskCaptureHint': 'どこでもコピーしたテキストを .compass/inbox へ保存します',
  'settings.deskCaptureAccelerator': 'ショートカット',
  ...
  'desk.draftPrompt.sourceWithFile':
    'ソースは {mention} です。frontmatter の sourcePath にはそのファイルのワークスペース相対パスを入れてください。',
  'desk.draftPrompt.sourceOpen':
    'ソースはユーザーメッセージ／開いているエディタの内容を使ってください。',
  'desk.draftPrompt.path': '出力パス（必須）: {path}',
  'desk.draftPrompt.footer':
    '他のファイルは変更しないでください。提出前に読める簡潔な下書きにしてください。回答は設定言語に合わせてください。',
  'desk.draftPrompt.shape.mail':
    'frontmatter 必須: kind: outbox / preset: mail / status: draft / to: "" / subject: "…" / createdAt: ISO8601。続けてメール本文（そのまま貼れるプレーン文）。',
  'desk.draftPrompt.shape.minutes':
    'frontmatter: kind outbox, preset minutes, status draft, createdAt。本文は ## 決定事項 / ## TODO / ## 共有事項。',
  'desk.draftPrompt.shape.report':
    'frontmatter: kind outbox, preset report, status draft, createdAt。本文は ## 背景 / ## 現状 / ## 提案。',
  'desk.draftPrompt.shape.chat':
    'frontmatter: kind outbox, preset chat, status draft, createdAt。本文は短い投稿（箇条書き可）。',
  ...
  'git.notRepoHint': 'ターミナルで git init するか、clone したフォルダを開いてください',
  'git.statusFailed': 'git status に失敗しました',
  'git.diffFailed': 'git diff に失敗しました',
  'git.stageFailed': 'ステージに失敗しました',
  'git.unstageFailed': 'ステージ解除に失敗しました',
  'git.commitFailed': 'コミットに失敗しました',
  'git.discardFailed': '変更の破棄に失敗しました',
  'git.pushFailed': 'push に失敗しました',
  'git.pullFailed': 'pull に失敗しました',
  'git.branchListFailed': 'ブランチ一覧の取得に失敗しました',
  'git.checkoutFailed': 'ブランチの切り替えに失敗しました',
  'git.noRemote': 'リモート origin がありません。ターミナルで remote を追加してください',
  'git.invalidBranch': '無効なブランチ名です',
  'git.emptyMessage': 'コミットメッセージを入力してください',
  'git.messageTooLong': 'コミットメッセージが長すぎます（最大 {max} 文字）',
  'git.nothingToCommit': 'ステージされた変更がありません',
  'git.noPaths': 'ファイルが選択されていません',
  'git.tooManyPaths': '一度に扱えるファイルは {max} 件までです',
  'git.invalidPath': '無効なパスです',
  'git.timeout': 'Git コマンドがタイムアウトしました',
  'git.branch': 'ブランチ',
  'git.branchSwitch': 'ブランチを切り替え',
  'git.aheadBehind': '↑{ahead} ↓{behind}',
  'git.aheadBehindHint':
    '未同期: ローカルが {ahead} コミット先行、リモートが {behind} コミット先行。Pull / Push で同期できます',
  'git.staged': 'ステージ済み',
  'git.changes': '変更',
  'git.untracked': '未追跡',
  'git.empty': '変更はありません',
  ...
  'git.discardAllConfirm': '{count} 件の変更を破棄しますか？この操作は元に戻せません。',
  'git.discardUntrackedConfirm':
    '未追跡の「{path}」を削除しますか？この操作は元に戻せません。',
  'git.stageAll': 'すべてステージ',
  'git.unstageAll': 'すべて解除',
  'git.commit': 'コミット',
  'git.commitMessage': 'コミットメッセージ',
  'git.commitMessagePlaceholder': '変更内容を短く書く',
  'git.commitSuccess': 'コミットしました ({hash})',
  'git.push': 'Push',
  'git.pull': 'Pull',
  'git.pushSuccess': 'push しました',
  'git.pullSuccess': 'pull しました',
  'git.pushHint': 'リモートへ push',
  'git.pullHint': 'リモートから pull（fast-forward のみ）',
  'git.checkoutSuccess': 'ブランチを切り替えました ({branch})',
  'git.openFile': 'ファイルを開く',
  'git.showDiff': '差分を表示',
  'git.diffTitle': '差分: {path}',
  'git.diffStaged': 'ステージ済み',
  'git.diffUnstaged': '作業ツリー',
  'git.diffEmpty': '表示する差分がありません',
  'git.diffTruncated': '差分が長いため一部のみ表示しています',
  'git.kind.modified': '変更',
  'git.kind.added': '追加',
  'git.kind.deleted': '削除',
  'git.kind.renamed': '名前変更',
  'git.kind.copied': 'コピー',
  'git.kind.untracked': '未追跡',
  'git.kind.ignored': '無視',
  'git.kind.conflict': '競合',
  'git.selectHint': 'ファイルを選んで差分を表示、またはステージしてコミットできます',
  'git.error': 'Git エラー: {message}',
  'status.gitBranch': '{branch}',
  'status.gitOpen': 'Git パネルを開く',
  ...
  'explorer.openWithDefaultApp': '既定のアプリで開く',
  'explorer.openWithDefaultAppFailed': '既定のアプリで開けませんでした',
  'explorer.openInTabBrowser': 'タブブラウザで開く',
  'explorer.compareWith': 'と比較...',
  'explorer.compareSelected': '選択したファイルを比較',
  'explorer.compareSameFile': '同じファイル同士は比較できません',
  'explorer.compareNotText': 'テキストファイルのみ比較できます',
  'explorer.compareFailed': 'ファイルの比較を開けませんでした',
  ...
  'explorer.copyFailed': 'コピーに失敗しました',
  'explorer.pasteFailed': '貼り付けに失敗しました',
  ...
  'search.modeHybrid': '意味',
  'search.modeKeyword': '文字',
  'search.modeHybridTitle': 'ハイブリッド検索（意味 + キーワード）',
  'search.modeKeywordTitle': 'キーワード検索（完全一致に近い文字検索）',
  ...
  'chat.agentToolName.profileData': 'データをプロファイル',
  'chat.agentToolName.queryData': 'データ照会',
  ...
  'editor.compareBadge': '比較',
  'editor.compareTab': '{left} ↔ {right}',
  'editor.compareSwap': '左右を入れ替え',
  'editor.compareSideBySide': '左右',
  'editor.compareInline': 'インライン',
  ...
  'editor.pdfLabel': 'PDF',
  'editor.binaryLabel': 'バイナリ',
  'editor.binaryUnsupportedTitle': 'このファイルは表示できません',
  'editor.binaryUnsupportedMessage':
    'バイナリファイルのためエディタでは開けません。既定のアプリで開いてください。',
  'editor.binaryFileSize': 'サイズ: {size}',
  'editor.openMediaFailed': 'メディアファイルを開けませんでした',
  'editor.openFileFailed': 'ファイルを開けませんでした',
  'editor.closeTab': '閉じる',
  ...
  'status.usage': '期間 {requests}回 / {tokens} tok',
  'status.usageHint': '集計期間: {start} 〜 {end}\nクリックで設定を開く',
  'status.usageMissingHint': '一部の呼び出しはトークン未取得',
  ...
  'status.indexingProgress': 'インデックス更新中... {percent}%',
  ...
  'terminal.new': '新しいターミナルを開く',
  'terminal.selectShell': 'シェルを選択して開く',
  ...
  'fs.cannotCopyIntoSelf': 'フォルダを自分自身またはその中にはコピーできません',
  ...
  'ai.askSystemPrompt':
    '現在はAskモードです。説明、質問への回答、調査、レビューのみを行い、ワークスペースへのファイル作成・変更・削除は行わないでください。```compass-actions```コードブロックは絶対に出力しないでください。コード例や文言例は通常の```コードブロックで示し、ユーザーが手動で適用できるようにしてください。プロジェクト構造インデックス(.compass)や Related workspace excerpts が提供された場合は、パス・見出し・スニペットを引用して「どこにあるか」にも答えてください。ワークスペースルール（.compass/rules.md）や用語集があればトーン・用語に従ってください。',
  'ai.agentSystemPrompt':
    'Agent としてツール（readFile / listDir / search / searchMeaning / proposeActions / verify / exec / updateTodo / checkpoint / remember）でワークスペースを調査・変更提案・検証・短いコマンド実行ができます。意味・トピックで探すときは searchMeaning、文言の完全一致は search を使ってください。パスはすべてワークスペースルートからの相対パスです。ルートは "." を使い、ワークスペースフォルダ名そのものをサブパスにしないでください。ファイル変更は proposeActions で提案し、ユーザーがプレビュー承認するまで適用されません。チャット本文や ```compass-actions``` / actions JSON に変更を書いてもプレビューも適用もされません。変更依頼では必ず proposeActions ツールを呼び、途中切れしたら1ファイルずつ短い applyPatch で再提案してください。proposeActions の actions は必ず JSON 配列として渡し、JSON 文字列や一塊の文字列にしないでください。既存ファイルの修正は applyPatch（unified diff・変更 hunk のみ）を優先し、大きな全文 writeFile は避けてください。Markdown の特定見出し配下だけ書き換えるときは replaceSection（path + heading + 章本文）を使い、他の章を触らないでください。patch は @@ -start,count +start,count @@ 形式のみ。*** Begin Patch / *** Update File: 形式は禁止。同一ファイルへの変更は1つの applyPatch にまとめてください。関連する複数ファイルの変更は1回の proposeActions にまとめてよいですが、無関係な作業や大きい変更セットは複数回に分割してください。新規ファイルやごく短い全置換だけ writeFile を使ってください。変更が適用されたら、終了前に verify（test / lint / typecheck）で確かめてください。失敗したら proposeActions で直し、再度 verify する定石を守ってください。verify が解決できない場合のみ exec で同等のコマンドを実行してください。スクリプトが無く verify がスキップされただけなら、最終回答では触れないでください（タイムラインに表示済み）。実際に実行して失敗したときだけ検証結果を書いてください。exec はビルドやアドホックな短命非対話コマンド向けです。ワークスペース全体の削除（例: rm -rf .）などの危険コマンドは拒否され、rm や git reset --hard などの書き込み系はユーザー承認後のみ実行されます。ユーザー用ターミナルとは別です。Windows では Git Bash があればそこで実行されます（なければ cmd.exe）。同じファイルを再読するとキャッシュヒット（アウトラインのみ）になることがあります。全文が必要なら force=true を渡してください。複数依頼や長めの変更は、作業前に updateTodo で中粒度のチェックリストにしてください（目安 5〜12。調査／実装／テストのような粗い3フェーズや、過剰な細分化は避ける）。各項目は検証可能な成果（対象・挙動・確認内容）にし、受け入れ条件が不明なら実装前に確認または仮定を明示する項目を入れてください。調査で前提が変わったら merge=true で計画を更新して構いません。pending / in_progress が残っている間はテキストだけで終了せず、ツールで続けてください。全項目が done / cancelled になってから簡潔な最終回答を返してください。単一依頼でも複数ステップなら早めに updateTodo を使ってください。重要な発見・原因・契約は remember で作業メモリに残してください。ターン／ツール上限の直前や長い調査の区切りでは checkpoint に短い再開要約（何が済み、何が残るか）を残してください。Continue 後は計画と作業メモリを優先して続けてください。ワークスペースルール（.compass/rules.md）や用語集があれば従ってください。必要なツールを使い、依頼を完了してから簡潔な結論をテキストで返してください。',
  ...
  'ai.agentModeReminder':
    '[Agentモード] readFile / listDir / search / searchMeaning で調査（意味・トピックは searchMeaning）、変更は必ず proposeActions ツール（チャットや compass-actions では不可。actions は配列。既存ファイルは applyPatch＝unified diff の @@ hunkのみ、*** Begin Patch 禁止、同一ファイルは1パッチ。新規・短い全置換は writeFile。途中切れは1ファイルずつ再提案）。適用後は verify（test/lint/typecheck）→失敗なら再提案のループ。スクリプト無しのスキップは最終回答で触れない。verify 不可時のみ exec（短命・ワークスペース内。破壊的コマンドは拒否／書き込み系は承認）。複数依頼や長めのタスクは先に updateTodo で中粒度（目安5〜12、検証可能な項目）に分解し、受け入れ条件が不明なら実装前に確認する。pending が残る間は終了しない（checkpoint / remember も活用。調査後は計画更新可）。関連変更は1提案、無関係・大規模は proposeActions を分割。同じファイルの再読はキャッシュされる（force=true で再取得）。パスは相対、ルートは "."。',
  'ai.responseLanguage':
  ...
  'ai.agentInitialTodoPlanNudge':
    '[Agent] 複数依頼または長めのタスクに見えます。\n先に updateTodo で計画してください。目安は 5〜12 項目。\n各 todo は「終わったと判定できる単位」にし、次を避けてください:\n- 調査 / 実装 / テスト のような粗いフェーズ名だけ\n- 10分未満で終わる作業の過剰分割\n調査が必要な項目は「何を確かめるか」まで書き、実装項目は「どの成果物／挙動」まで書いてください。\n受け入れ条件が不明なら、実装の前に確認または仮定を明示する todo を1つ入れてください。\ntodo の status を最新に保ち、調査で前提が変わったら merge=true で計画を更新して構いません。\n関連するファイル変更は1回の proposeActions にまとめてよく、無関係な作業は別提案にしてください。\npending / in_progress の todo が残っている間は終了しないでください。',
  'ai.agentCoarseTodoPlanNudge':
    '[Agent] 計画が粗すぎます（{count}件）。\n調査対象・変更対象・検証観点・受け入れ条件が分かる単位に再分解して updateTodo してください。\n目安は 5〜12 件。「調査」「実装」「テスト」だけの項目名は避けてください。\nすでに十分な単一修正ならこのままで構いません。',
  ...
  'ai.agentMissingProposeActionsNudge':
  ...
  'ai.agentProposeActionsFormatError':
    'proposeActions の形式ミスです（{reason}）。actions は JSON 配列として直接渡し、文字列化しないでください。正しい形式で再提案してください。既存ファイルは applyPatch。関連する変更は1回にまとめ、無関係・大きい変更は複数回の proposeActions に分割してください。',
  'ai.agentProposeActionsTruncated':
    'proposeActions の引数が途中で切れました（出力トークン上限の可能性が高いです）。不完全な writeFile / applyPatch はプレビューしません。既存ファイルは短い applyPatch hunk で再提案し、無関係な変更や大きな変更セットは複数回の proposeActions に分割してください（1ファイルずつでも可）。',
  ...
  'ai.workspaceRulesHeader': '[ワークスペースルール (.compass/rules.md)]',
  'ai.workspaceGlossaryHeader': '[ワークスペース用語集 (.compass/glossary.md)]',
  'ai.indexLines': '{count}行',
  'rules.edit': 'ルールを編集',
  'rules.openFailed': 'ワークスペースルールを開けませんでした',
  'rules.openGlossaryFailed': '用語集を開けませんでした',
  'chat.emptyRulesHint':
    'トーンや用語はファイル → ワークスペースルールを編集（.compass/rules.md）に書くと、次回から自動で効きます',
...
export const en: Record<MessageKey, string> = {
  ...
  'settings.usageTokensDetail': 'Input {prompt} / Output {completion} / Total {total}',
  'settings.usageMissing': 'Calls without token usage: {count}',
  'settings.usageResetDay': 'Usage reset day',
  'settings.usageResetDayHint': 'Usage counters reset on this day each month (1–28)',
  'settings.usageReset': 'Reset period usage',
  'settings.usageResetConfirm': 'Reset usage counters for the current period to zero?',
  ...
  'menu.workspaceRules': 'Edit Workspace Rules',
  'menu.workspaceGlossary': 'Edit Glossary',
  'menu.quit': 'Quit',
  'menu.undo': 'Undo',
  'menu.redo': 'Redo',
  ...
  'menu.terminalShortcut': 'Ctrl+`',
  'menu.newTerminal': 'Open New Terminal',
  'menu.newTerminalShortcut': 'Ctrl+Shift+`',
  ...
  'menu.showGit': 'Show Git',
  'menu.showDesk': 'Show Clip',
  ...
  'sidebar.git': 'Git',
  'sidebar.desk': 'Clip',
  'desk.noWorkspace': 'Open a folder to use Clip',
  'desk.inbox': 'Inbox',
  'desk.outbox': 'Outbox',
  'desk.inboxEmpty': 'Capture text with the hotkey (default: Ctrl+Alt+I)',
  'desk.outboxEmpty': 'Drafts you create will appear here',
  'desk.markDone': 'Done',
  'desk.markAllDone': 'Done all',
  'desk.markAllDoneConfirm': 'Mark all inbox items as done? (moves them to done/)',
  'desk.hasOutbox': 'Created',
  'desk.copied': 'Copied',
  'desk.archive': 'Done',
  'desk.archiveAll': 'Done all',
  'desk.archiveAllConfirm': 'Archive all outbox items?',
  'desk.delete': 'Delete',
  'desk.deleteConfirm': 'Permanently delete this Outbox draft?\n{name}',
  'desk.deleteInboxConfirm': 'Permanently delete this inbox capture?\n{name}',
  'desk.outbox.notOutbox': 'Not an outbox file',
  'desk.open': 'Open',
  'desk.shipCheck': 'Check & copy',
  'desk.createDraft': 'Create draft…',
  'desk.createDraftShort': 'Draft…',
  'desk.draftTitle': 'Create draft',
  'desk.draftPreset': 'Format',
  'desk.preset.mail': 'Mail',
  'desk.preset.minutes': 'Minutes',
  'desk.preset.report': 'Report',
  'desk.preset.chat': 'Chat post',
  'desk.draftCreate': 'Create',
  ...
  'desk.capture.empty':
    'Clipboard has no text. Copy from mail or a browser, then press the hotkey again.',
  'desk.capture.tooLarge':
    'Text is too large (max 512KB). Copy a shorter selection and try again.',
  'desk.capture.notifyOkTitle': 'Captured',
  ...
  'desk.status.ready': 'copied',
  'desk.status.archived': 'archived',
  'desk.fromSource': 'From: {name}',
  'settings.desk': 'Clip',
  'settings.deskCapture': 'Clipboard capture hotkey',
  'settings.deskCaptureHint': 'Saves copied text into .compass/inbox from anywhere',
  'settings.deskCaptureAccelerator': 'Shortcut',
  ...
  'desk.draftPrompt.sourceWithFile':
    'Use {mention} as the source. Set sourcePath in frontmatter to that file’s workspace-relative path.',
  'desk.draftPrompt.sourceOpen':
    'Use the user message / open editor context as the source.',
  'desk.draftPrompt.path': 'Required path: {path}',
  'desk.draftPrompt.footer':
    'Do not modify other files. Keep the draft concise and ready to ship after review. Respond in the configured UI language.',
  'desk.draftPrompt.shape.mail':
    'Required frontmatter: kind: outbox / preset: mail / status: draft / to: "" / subject: "…" / createdAt: ISO8601. Then the email body (plain, ready to paste).',
  'desk.draftPrompt.shape.minutes':
    'Frontmatter: kind outbox, preset minutes, status draft, createdAt. Body sections: ## Decisions / ## TODOs / ## Share.',
  'desk.draftPrompt.shape.report':
    'Frontmatter: kind outbox, preset report, status draft, createdAt. Body sections: ## Background / ## Status / ## Proposal.',
  'desk.draftPrompt.shape.chat':
    'Frontmatter: kind outbox, preset chat, status draft, createdAt. Body: short post; bullets OK.',
  ...
  'git.notRepoHint': 'Run git init in the terminal, or open a cloned folder',
  'git.statusFailed': 'git status failed',
  'git.diffFailed': 'git diff failed',
  'git.stageFailed': 'Failed to stage files',
  'git.unstageFailed': 'Failed to unstage files',
  ...
  'git.branchListFailed': 'Failed to list branches',
  'git.checkoutFailed': 'Failed to switch branch',
  'git.noRemote': 'No remote named origin. Add a remote in the terminal',
  'git.invalidBranch': 'Invalid branch name',
  'git.emptyMessage': 'Enter a commit message',
  'git.messageTooLong': 'Commit message is too long (max {max} characters)',
  'git.nothingToCommit': 'No staged changes to commit',
  'git.noPaths': 'No files selected',
  'git.tooManyPaths': 'Too many files (max {max})',
  'git.invalidPath': 'Invalid path',
  'git.timeout': 'Git command timed out',
  'git.branch': 'Branch',
  'git.branchSwitch': 'Switch branch',
  'git.aheadBehind': '↑{ahead} ↓{behind}',
  'git.aheadBehindHint':
    'Out of sync: local is {ahead} commit(s) ahead, remote is {behind} commit(s) ahead. Use Pull / Push to sync',
  'git.staged': 'Staged',
  'git.changes': 'Changes',
  ...
  'git.discardConfirm': 'Discard changes in “{path}”? This cannot be undone.',
  'git.discardAllConfirm': 'Discard {count} change(s)? This cannot be undone.',
  'git.discardUntrackedConfirm':
    'Delete untracked “{path}”? This cannot be undone.',
  'git.stageAll': 'Stage all',
  'git.unstageAll': 'Unstage all',
  'git.commit': 'Commit',
  'git.commitMessage': 'Commit message',
  'git.commitMessagePlaceholder': 'Short summary of the change',
  ...
  'git.pullHint': 'Pull from remote (fast-forward only)',
  'git.checkoutSuccess': 'Switched to {branch}',
  'git.openFile': 'Open file',
  'git.showDiff': 'Show diff',
  'git.diffTitle': 'Diff: {path}',
  'git.diffStaged': 'Staged',
  'git.diffUnstaged': 'Working tree',
  'git.diffEmpty': 'No diff to show',
  'git.diffTruncated': 'Diff truncated — showing the beginning only',
  ...
  'git.kind.ignored': 'Ignored',
  'git.kind.conflict': 'Conflict',
  'git.selectHint': 'Select a file to view its diff, or stage files and commit',
  'git.error': 'Git error: {message}',
  'status.gitBranch': '{branch}',
  'status.gitOpen': 'Open Git panel',
  ...
  'explorer.openWithDefaultApp': 'Open with Default App',
  'explorer.openWithDefaultAppFailed': 'Failed to open with the default app',
  'explorer.openInTabBrowser': 'Open in Tab Browser',
  'explorer.compareWith': 'Compare with...',
  'explorer.compareSelected': 'Compare Selected Files',
  'explorer.compareSameFile': 'Cannot compare a file with itself',
  'explorer.compareNotText': 'Only text files can be compared',
  'explorer.compareFailed': 'Could not open file comparison',
  ...
  'explorer.copyFailed': 'Failed to copy',
  'explorer.pasteFailed': 'Failed to paste',
  ...
  'search.modeHybrid': 'Meaning',
  'search.modeKeyword': 'Text',
  'search.modeHybridTitle': 'Hybrid search (meaning + keywords)',
  'search.modeKeywordTitle': 'Keyword search (literal text match)',
  ...
  'chat.summarizeToMarkdownPrompt':
    'Summarize the extracted text from {mention} as Markdown and write it to `{sidecar}` with a compass-actions writeFile (overwrite if it already exists). Use clear headings, keep it readable, and do not edit the source file.',
  'chat.askAboutDataPrompt':
  ...
  'chat.agentToolName.profileData': 'Profile data',
  'chat.agentToolName.queryData': 'Query data',
  ...
  'editor.compareBadge': 'Compare',
  'editor.compareTab': '{left} ↔ {right}',
  'editor.compareSwap': 'Swap sides',
  'editor.compareSideBySide': 'Side by side',
  'editor.compareInline': 'Inline',
  ...
  'editor.pdfLabel': 'PDF',
  'editor.binaryLabel': 'Binary',
  'editor.binaryUnsupportedTitle': 'This file cannot be displayed',
  'editor.binaryUnsupportedMessage':
    'This is a binary file and cannot be opened in the editor. Open it with the default app instead.',
  'editor.binaryFileSize': 'Size: {size}',
  ...
  'status.usage': 'Period {requests} / {tokens} tok',
  'status.usageHint': 'Period: {start} – {end}\nClick to open settings',
  'status.usageMissingHint': 'Some calls had no token usage',
  ...
  'status.indexingProgress': 'Updating index... {percent}%',
  ...
  'terminal.selectShell': 'Select shell to open',
  ...
  'fs.cannotCopyIntoSelf': 'Cannot copy a folder into itself or its descendant',
  ...
  'ai.agentInitialTodoPlanNudge':
    '[Agent] This looks like a multi-part or longer task.\nCall updateTodo first with a medium-granularity plan (about 5–12 items).\nEach todo must be verifiable when done. Avoid:\n- coarse phase labels alone (investigate / implement / test)\n- over-splitting work that takes under ~10 minutes\nFor investigate items, say what you will check; for implement items, say which artifact/behavior.\nIf acceptance criteria are unclear, add one clarify-or-state-assumptions todo before implementation.\nKeep statuses current; after investigation changes assumptions, update with merge=true.\nRelated file edits may share one proposeActions; unrelated work should be separate proposals.\nDo not finish while any todo is pending or in_progress.',
  'ai.agentCoarseTodoPlanNudge':
    '[Agent] This plan is too coarse ({count} items).\nCall updateTodo again and split into units that name what to inspect, what to change, how to verify, and acceptance criteria.\nAim for about 5–12 items. Avoid labels that are only "investigate", "implement", or "test".\nIf this is already a sufficient single fix, you may keep the current plan.',
  'ai.agentOpenTodosNudge':
  ...
  'ai.agentProposeActionsFormatError':
    'Invalid proposeActions format ({reason}). Pass `actions` as a JSON array directly—do not stringify it. Re-propose correctly. Prefer applyPatch for existing files. Batch related edits in one proposal; split unrelated or large changes across multiple proposeActions calls.',
  'ai.agentProposeActionsTruncated':
    'proposeActions arguments were truncated (likely hit the output token limit). Incomplete writeFile/applyPatch payloads are not shown in preview. Prefer small applyPatch hunks for existing files, and split unrelated or large change sets across multiple proposeActions calls (one file at a time is fine).',
  'ai.agentToolsUnsupported':
  ...
  'ai.workspaceRulesHeader': '[Workspace rules (.compass/rules.md)]',
  'ai.workspaceGlossaryHeader': '[Workspace glossary (.compass/glossary.md)]',
  'ai.indexLines': '{count} lines',
  'rules.edit': 'Edit rules',
  'rules.openFailed': 'Could not open workspace rules',
  'rules.openGlossaryFailed': 'Could not open glossary',
  'chat.emptyRulesHint':
    'Tone and terms: File → Edit Workspace Rules (.compass/rules.md) — applied automatically next time',
  'ai.inlineCompletionSystemPromptCode':
