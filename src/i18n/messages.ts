export const ja = {
  ...
  'desk.outbox': '出す前',
  'desk.digest': '振り返り',
  'desk.inboxEmpty': 'ホットキーでテキストを取りこめます（既定: Ctrl+Alt+I）',
  'desk.outboxEmpty': '下書きを作るとここに並びます',
  'desk.digestEmpty': 'この1週間の変化を1枚にまとめられます',
  'desk.markDone': '済',
  'desk.archive': '済',
  'desk.delete': '削除',
  'desk.deleteConfirm': 'この Outbox 下書きを完全に削除しますか？\n{name}',
  'desk.deleteDigestConfirm': 'このダイジェストを完全に削除しますか？\n{name}',
  'desk.outbox.notOutbox': 'outbox のファイルではありません',
  'desk.digest.notDigest': 'digests のファイルではありません',
  'desk.open': '開く',
  'desk.shipCheck': '検品してコピー',
  'desk.createDraft': '下書きを作る…',
  'desk.createDigest': 'ダイジェストを作る',
  ...
  'desk.ship.close': '閉じる',
  'desk.digestEmptyPeriod': 'この期間の変化は見つかりませんでした',
  'desk.digestStarting': 'ダイジェスト用の文脈を集めています…',
  'desk.capture.noWorkspace': '先にフォルダを開いてください',
  'desk.capture.empty': 'コピーしたテキストがありません',
  'desk.capture.tooLarge': 'テキストが大きすぎます（上限 512KB）',
  'desk.capture.notifyTitle': 'Compass クリップ',
  'desk.capture.notifyOk': 'inbox に保存しました',
  ...
  'desk.digestPrompt.intro':
    '```compass-actions``` の writeFile 1回で、ダイジェストを `{path}` に作成（同日なら上書き）してください。',
  'desk.digestPrompt.period': '期間: {start} → {end}（ローカル日時）。',
  'desk.digestPrompt.frontmatter':
    'frontmatter 必須: kind: digest, periodStart, periodEnd, createdAt (ISO8601), filesConsidered, truncated (true/false)。',
  'desk.digestPrompt.sections':
    '本文セクション: ## 決定事項 / ## 未解決 / ## 次のアクション / ## 主な変更ファイル。',
  'desk.digestPrompt.footer':
    '可能ならワークスペース相対パスを根拠として示してください。文脈にないファイルは作らないでください。回答は設定言語に合わせてください。',
  'desk.digestPrompt.contextHeader': '--- 収集したワークスペース文脈 ---',
...
export const en: Record<MessageKey, string> = {
  ...
  'desk.digestEmpty': 'Summarize what changed in the last 7 days',
  'desk.markDone': 'Done',
  'desk.archive': 'Done',
  'desk.delete': 'Delete',
  'desk.deleteConfirm': 'Permanently delete this Outbox draft?\n{name}',
  'desk.deleteDigestConfirm': 'Permanently delete this digest?\n{name}',
  'desk.outbox.notOutbox': 'Not an outbox file',
  'desk.digest.notDigest': 'Not a digest file',
  'desk.open': 'Open',
  'desk.shipCheck': 'Check & copy',
  'desk.createDraft': 'Create draft…',
  'desk.createDigest': 'Create digest',
  ...
  'desk.digestEmptyPeriod': 'No changes found in this period',
  'desk.digestStarting': 'Collecting digest context…',
  'desk.capture.noWorkspace': 'Open a folder first',
  'desk.capture.empty': 'Clipboard has no text',
  'desk.capture.tooLarge': 'Text is too large (max 512KB)',
  'desk.capture.notifyTitle': 'Compass Clip',
  'desk.capture.notifyOk': 'Saved to inbox',
  ...
  'desk.digestPrompt.intro':
    'Create or overwrite the digest at `{path}` with a single writeFile compass-actions block.',
  'desk.digestPrompt.period': 'Period: {start} → {end} (local).',
  'desk.digestPrompt.frontmatter':
    'Frontmatter must include: kind: digest, periodStart, periodEnd, createdAt (ISO8601), filesConsidered, truncated (true/false).',
  'desk.digestPrompt.sections':
    'Body sections: ## Decisions / ## Open questions / ## Next actions / ## Main files touched.',
  'desk.digestPrompt.footer':
    'Cite workspace-relative paths where possible. Do not invent files that were not in the context. Respond in the configured UI language.',
  'desk.digestPrompt.contextHeader': '--- Collected workspace context ---',
